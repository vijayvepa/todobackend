...
def createItem(client):
    ...
    data = {'title': 'Feed the baby'}
    return client.post(url, data, format='json')


class TestCreateTodoItem(APITestCase):
    """
    Ensure we can create new to do item
    """
    ...
    def test_item_has_correct_title(self):
        self.assertEqual(TodoItem.objects.get().title, 'Feed the baby')


class TestUpdateTodoItem(APITestCase):
    """
    Ensure we can update an existing to do item using PUT
    """
    ...
    def setUp(self):
        ...
        data = {'title': 'Feed the baby', 'completed': True}
...
class TestPatchTodoItem(APITestCase):
    """
    Ensure we can update an existing to do item using patch
    """
...
class TestDeleteTodoItem(APITestCase):
    """
    Ensure we can delete a to do item
    """
